...
<body class="bg-[#eeeded]">
    <div class="max-w-2xl mx-auto rounded-xl pb-8 pt-6">
        ...
        {{-- @if (request('registered') == 'success')
            <div class="bg-green-100 text-green-700 p-2 rounded mb-3">Register berhasil, silahkan Login</div>
        @endif --}}
    ...
    <div
        id="header"
        class="bg-green-500 px-8 py-8 text-center transition-all duration-500">
        <img
        ...
        <p
            id="subtitle"
            class="mt-2 text-md text-white/90">
    ...
    <div id="formContainer" class="overflow-hidden transition-all duration-500">
        <div
            id="formWrapper"
            class="flex w-[200%] items-start transition-all duration-500 ease-in-out">
            <!-- LOGIN -->
            <div id="loginForm" class="w-1/2 p-8 pt-6">
                ...
                <form action="/login" method="POST">
                    ...
                    <button type="submit" class="w-full rounded-xl bg-green-500 py-3 font-semibold text-white hover:bg-green-600 cursor-pointer">
                        Login
                    </button>
                </form>
            </div>
            ...
            <div id="registerForm" class="w-1/2 p-8 pt-6">
                ...
                <form action="/register" method="POST">
                    ...
                    <button type="submit" class="w-full rounded-xl bg-blue-500 py-3 font-semibold text-white hover:bg-blue-600 cursor-pointer">
                        Register
                    </button>
                </form>
            </div>
