<div id="modal" class="fixed w-full inset-0 bg-black/50 hidden">
<div class="bg-white flex flex-col max-w-4xl mx-auto mt-8 p-4 rounded">
    <!-- Biodata -->
    <div class="rounded-2xl border border-slate-200 p-4">
        ...
        <div class="grid grid-cols-6 gap-3">
            ...
            <div>
               ...
               <p id="review_nilai_rata" class="font-medium text-slate-800">-</p>
            </div>
        </div>
    </div>
    <!-- Orang Tua -->
    ...
    <!-- Persetujuan -->
        ...
        <div class="border border-amber-200 bg-amber-50 p-2">
            ...
            <label class="flex items-start gap-3">
                ...
                >
                <span class="text-sm text-slate-700">
                    Saya menyatakan bahwa seluruh data yang saya unggah adalah benar dan dapat dipertanggung jawabkan. Apabila di kemudian hari ditemukan ketidaksesuaian data, saya bersedia menerima keputusan yang ditetapkan oleh panitia PPDB.
                </span>
            </label>
        </div>
        <div class="mt-2 flex justify-end">
            <button id="close" type="button" class="rounded-xl bg-blue-600 px-8 py-3 font-medium text-white hover:bg-blue-700 cursor-pointer">
                Konfirmasi
            </button>
        </div>
</div>
