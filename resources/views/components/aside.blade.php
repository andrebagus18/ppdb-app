<aside class="w-64 bg-slate-900 p-4">
    ...
    <nav class="space-y-2 pt-4">
        <a href="#" data-target="dashboard-content"  class="cursor-pointer flex gap-3 p-2 text-slate-200 text-lg rounded hover:text-black hover:bg-gray-100">
            <i data-lucide="home"></i>
            <span>Dashboard</span>
        </a>
        <a href="#" data-target="formulir-content" class="cursor-pointer flex gap-3 p-2 text-slate-200 text-lg rounded hover:text-black hover:bg-gray-100">
            <i data-lucide="form"></i>
            <span>Data Formulir</span>
        </a>
        <a href="#" data-target="upload-berkas-content" class="cursor-pointer flex gap-3 p-2 text-slate-200 text-lg rounded hover:text-black hover:bg-gray-100">
            <i data-lucide="upload"></i>
            <span>Upload Dokumen</span>
        </a>
        <a href="#" data-target="pengumuman-content" class="cursor-pointer flex gap-3 p-2 text-slate-200 text-lg rounded hover:text-black hover:bg-gray-100">
