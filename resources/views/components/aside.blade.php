...
@if (auth()->user()->role === 'siswa')
    <aside class="w-64 bg-blue-700 p-4">
...
@elseif (auth()->user()->role === 'panitia')
    <aside class="w-64 bg-emerald-900 p-4">
        <div class="w-full p-8 flex flex-col items-center border-b-2 border-slate-300">
            <div class="w-30 h-30 rounded-full border-4 border-teal-600 bg-white overflow-hidden mb-2">
