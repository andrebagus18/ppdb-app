                    ...
                    <div class="grid gap-2 grid-cols-1">
                        <div class="flex items-center justify-between p-2">
                            <div>
                                ...
                                <p class="text-lg text-black font-medium italic">{{ $document->jenis_document }}_siswa.file
                                </p>
                                <a href="{{ $document->cloudinary_url }}" target="blank"
                                    class="text-sm italic text-blue-500">Lihat
                                    file unggahan</a>
                    ...
                    <div class="flex items-center justify-between p-2">
                        <div>
                            <label class="mb-2 block text-lg font-medium">
                                ...
                                <span class="italic text-sm text-slate-400">Upload foto maksimal 5MB</span>
                            </label>
