...
<body>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="p-4 text-right">
                               ...
                               class="text-indigo-600 hover:underline">
                                ...
                                <button type="button" onclick="openModal({{ $registration->id }})"
                                    class="text-indigo-600 hover:underline">
                                    Detail
                                </button>
                            </td>
    ...
    {{-- @endsection --}}
    <div id="detailModal" class="hidden flex fixed inset-0 bg-black/50 items-center justify-center z-50">
        ...
        <div class="bg-white w-[750px] rounded-xl p-6 relative">
           ...
           class="absolute top-3 right-3 text-red-500">
            ...
            <button type="button" id="closeModal" class="absolute top-3 right-3 text-red-500">
                ✕
            </button>
                ...
                @foreach ($registration->documents as $doc)
                    <div class="border p-3 rounded mb-2 flex justify-between items-center">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ $doc->cloudinary_url }}" target="_blank" class="text-blue-600 text-sm">
                                View
                            </a>
                            ...
                            <form method="POST" action="{{ route('panitia.reject', $doc) }}">
                                ...
                                <input name="catatan" placeholder="Alasan..." class="border text-xs px-2 w-28">
...
{{-- modal --}}
<div id="detailModal" class="hidden fixed inset-0 bg-black/50 items-center justify-center z-50">
    <div class="bg-white w-270 rounded-xl p-4 m-5 relative">
        <h2 class="text-xl font-bold mb-3">Data Pendaftar</h2>
        <button type="button" id="closeModal" class="absolute top-3 right-3 text-red-500 cursor-pointer">
            <i data-lucide="x"></i>
        </button>
        {{-- ISI MODAL --}}
                ...
                @if (isset($registration))
                    <div class="flex flex-col justify-center gap-1">
                        <div class="bg-slate-100/40 border border-slate-200 rounded-xl p-2">
                            <p class="uppercase"><b>Nama:</b> {{ $registration->student->nama_lengkap }}</p>
                            <p><b>No Pendaftaran:</b> {{ $registration->no_daftar }}</p>
                        </div>
