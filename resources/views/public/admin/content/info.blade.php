<div class="p-6" data-tab="dashboard">
    <div class="p-2 pt-0 flex gap-6">
        <div class="flex flex-col gap-2 bg-slate-700/30 p-4 pb-2 w-full">
            {{-- CARD  --}}
            <div class="grid grid-cols-5 gap-4">
                <div
                    class="bg-indigo-500/20 backdrop-blur-2xl text-indigo-500 border-2 border-indigo-500 p-4 rounded-lg flex flex-col gap-2 text-lg shadow-lg">
                ...
                <div
                    class="bg-yellow-500/20 backdrop-blur-2xl text-yellow-500 border-2 border-yellow-500 p-4 rounded-lg flex flex-col gap-2 text-lg shadow-lg">
                    <div class="flex h-10 items-center font-bold gap-2">
                ...
                <div
                    class="bg-blue-500/20 backdrop-blur-2xl text-blue-500 border-2 border-blue-500 p-4 rounded-lg flex flex-col gap-2 text-lg shadow-lg">
                    <div class="flex h-10 items-center font-bold gap-2">
                ...
                <div
                    class="bg-green-500/20 backdrop-blur-2xl text-green-500 border-2 border-green-500 p-4 rounded-lg flex flex-col gap-2 text-lg shadow-lg">
                    <div class="flex h-10 items-center font-bold gap-2">
                ...
                <div
                    class="bg-red-500/20 backdrop-blur-2xl text-red-500 border-2 border-red-500 p-4 rounded-lg flex flex-col gap-2 text-lg shadow-lg">
                    <div class="flex h-10 items-center font-bold gap-2">
