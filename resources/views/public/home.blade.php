...
<section class="container mx-auto py-12 scroll-mt-10" id="jalur">
    <div class="flex flex-col items-center justify-center mb-10">
        ...
        <p class="w-[35em] text-slate-600 text-md text-center">Pilih jalur penerimaan yang sesuai dengan kriteria dan potensi Anda untuk memulai perjalanan pendidikan bersama kami.</p>
    </div>
    <div class="grid md:grid-cols-2 gap-8">
        <div class="bg-white p-6 rounded-xl shadow">
            ...
            <p class="mt-2 text-slate-600">
                Peserta didik diterima berdasarkan jarak tempat tinggal ke sekolah sesuai ketentuan wilayah yang berlaku.
            </p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow">
            <div class="flex justify-between mb-4">
            <h3 class="font-semibold text-xl">Jalur Prestasi 🎓</h3>
            <span class="w-auto bg-teal-700 text-white text-md rounded-full py-1 px-3">Kuota: 5/40</span>
            </div>
            <p class="mt-2 text-slate-600">
                Diperuntukkan bagi calon peserta didik yang memiliki prestasi akademik maupun non-akademik yang dibuktikan dengan sertifikat atau dokumen pendukung.
            </p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow">
            <div class="flex justify-between mb-4">
            <h3 class="font-semibold text-xl">Jalur Afirmasi ✨</h3>
            <span class="w-auto bg-teal-700 text-white text-md rounded-full py-1 px-3">Kuota: 5/45</span>
            </div>
            <p class="mt-2 text-slate-600">
...
<section class="container mx-auto py-12 scroll-mt-10" id="jadwal">
    <div class="flex flex-col items-center justify-center mb-10">
        ...
        <p class="w-[35em] text-slate-600 text-md text-center">Informasi tahapan dan waktu pelaksanaan Penerimaan Peserta Didik Baru PPDB. Pastikan mengikuti setiap jadwal yang telah ditentukan agar proses pendaftaran berjalan lancar.</p>
    </div>
...
<section class="container mx-auto py-12 scroll-mt-10" id="faq">
    <div class="flex flex-col items-center justify-center mb-10">
        ...
        <p class="w-[35em] text-slate-600 text-md text-center">Jawaban cepat untuk berbagai pertanyaan umum seputar pendaftaran, persyaratan, seleksi, dan daftar ulang peserta didik baru.</p>
    </div>
    <div class="max-w-3xl mx-auto flex justify-center gap-4">
        <div class="w-2xl grid grid-row-8 gap-4">
            <details class="faq bg-white border border-slate-200 py-2 px-4">
                ...
                <p class="text-slate-600 text-md">Tidak, proses pendaftaran PPDB tidak dipungut biaya sesuai dengan ketentuan yang berlaku.</p>
                </div>
            </details>
            <details class="faq bg-white border border-slate-200 py-2 px-4">
                <summary>▶  Bagaimana cara melakukan pendaftaran?</summary>
                <div class="content p-3">
                <p class="text-slate-600 text-md">Calon peserta didik dapat mendaftar secara online melalui website PPDB dengan mengisi formulir dan mengunggah dokumen yang diperlukan.</p>
                </div>
            </details>
            <details class="faq bg-white border border-slate-200 py-2 px-4">
                <summary>▶  Dokumen apa saja yang harus disiapkan?</summary>
                <div class="content p-3">
                <p class="text-slate-600 text-md">Umumnya meliputi Kartu Keluarga, Akta Kelahiran, rapor, pas foto, dan dokumen pendukung lainnya sesuai jalur pendaftaran.</p>
                </div>
            </details>
            <details class="faq bg-white border border-slate-200 py-2 px-4">
                <summary>▶  Bagaimana cara mengetahui hasil seleksi?</summary>
                <div class="content p-3">
                <p class="text-slate-600 text-md">Hasil seleksi dapat dilihat melalui halaman pengumuman pada website PPDB sesuai jadwal yang telah ditentukan.</p>
                </div>
            </details>
            <details class="faq bg-white border border-slate-200 py-2 px-4">
                <summary>▶  Bagaimana jika mengalami kendala saat pendaftaran?</summary>
                <div class="content p-3">
                <p class="text-slate-600 text-md">Silakan menghubungi panitia PPDB melalui kontak yang tersedia pada website untuk mendapatkan bantuan.</p>
                </div>
            </details>
        </div>
    </div>
